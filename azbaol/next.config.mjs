...
const nextConfig = {
    ...
    async headers() {
        ...
        connect-src 'self' http://10.151.78.44:5000 ws://10.151.78.44:5000 wss://10.151.78.44:5000 http://172.20.10.5:5000 ws://172.20.10.5:5000 wss://172.20.10.5:5000 https://*.googleapis.com https://*.mongodb.net https://*.cloudinary.com https://*.amazonaws.com;
