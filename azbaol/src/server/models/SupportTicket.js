...
// Export function
const getSupportTicketModel = async () => {
    if (mongoose.models.SupportTicket) {
        return mongoose.models.SupportTicket;
    }
    return model("SupportTicket", SupportTicketSchema);
};

export default getSupportTicketModel;